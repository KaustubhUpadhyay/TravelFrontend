...
function App() {
  ...
  React.useEffect(() => {
    const getPins = async () => {
      try {
        ...
        const res = await axios.get("https://travelpinapp-3yjw.onrender.com/api/pins");
        setPins(res.data);
      } catch (err) {
        console.log(err);
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("https://travelpinapp-3yjw.onrender.com/api/pins", newPin);
  ...
  const handleDelete = (e) => {
    ...
    try {
      axios.post("https://travelpinapp-3yjw.onrender.com/api/pins/delete", newPin);
